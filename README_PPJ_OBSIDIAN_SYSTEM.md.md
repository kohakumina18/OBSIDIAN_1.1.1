...
On Ubuntu, the enabled `ppj-executive-canvas-watcher.service` performs the guarded dry-run/apply cycle automatically within about 1-2 seconds after Obsidian saves the Canvas. Do not start another manual watcher while this service is active.
...
Current canonical portfolio (18/09/2026 baseline, `DEPARTMENT_APPLICATION_vMAJOR.MINOR.PATCH`). The authoritative list, stages, legacy names and open decisions live in `03_Projects/_Registry/PPJ_PORTFOLIO_CURRENT_SNAPSHOT.md`; physical note and folder names are unchanged and resolve through `PPJ_PROJECT_ALIAS_MAP`.

```text
FIN_FinanceManagement_v1.2.0            MER_CostingAgenticPlatform_v1.1.0
PUR_GDIAutomation_v1.0.0                TD_TechnicalKnowledgePlatform_v2.1.0
ADMIN_ExpenseManagement_v1.1.0          WH_AWBExtraction_v1.1.0
PUR_MaterialAllocation_v1.1.0           LOG_ExpenseInvoiceProcessing_v1.2.0
MER_InvoiceDataRecheck_v1.1.0           MER_MarketIntelligence_v1.1.0
SCP_SourcingChatbot_v2.3.0              HR_EmployeeDataPlatform_v1.1.0
AI_PERRIPlatform_v3.2.0                 AI_ApplicationHub_v2.1.0
FIN_InvoiceDownloader_v1.2.0            ACC_GRNSupplierInvoiceBot_v2.3.0
PUR_InventoryReport_v2.1.0              PUR_AdhocIndentSouth_v1.0.0
PROD_HangingLineIoT_v1.0.0              WASH_SamplingManagement_v1.1.0
WASH_COWASH_v2.0.0 (On Hold)            QC_DefectDetection_v1.0.0 (On Hold)
QC_ThreadTraceability_v1.0.0            FAB_FabricDatamart_v2.2.0
CPD_VisualSampleDatamart_v1.1.0         EXT_AcademicCollaboration_v1.1.0
PUR_HMLabelProcessing_v1.0.0 (On Hold)
Closed: ACC_InventoryReport_v1.0.0, MER_POCommit_v1.1.0, legacy EXIM Expense Invoice Automation,
        PPJxStratova.AI (historical), AI Automation Workshop (+ Analysis), VITAS Sharing
Retained legacy codes (not in the baseline): PPJ.GLPI.Helpdesk.AI.Chatbot.v1.0, PPJxNUNOX.ScanTrial
Discovery, not projects: DISCOVERY_PatternGenerationPoC (Stratova), Wizcore, Faceworks AI, Sortech, Quanskill
```
