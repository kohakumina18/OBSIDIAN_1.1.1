...
Registered as a canonical project by `PPJ-PORTFOLIO-SNAPSHOT-20260918` (previously the candidate `Warehouse AWB OCR`). It has no root project note or workspace yet; create them through the registration pipeline (`scripts/register_ppj_project.py`) rather than by hand.
...
- No root project note or workspace yet
