...
1. **Các dự án chiến lược đã tiến sâu hơn vào data foundation và rule definition**
    ...
    - Phần lớn nguồn cần thiết hiện nằm trong Databáse.WFX nhưng team chưa có tài khoản truy cập, tạo thành blocker lớn nhất.
...
2. **Các giải pháp nghiệp vụ đã bắt đầu chuyển từ prototype sang triển khai**
    ...
    - **`TD.TechnicalKnowledge.Platform.v2.1`** đã hoàn thành ETL cho các nguồn Technical hiện được xác định, đang trong quá trình UAT.
