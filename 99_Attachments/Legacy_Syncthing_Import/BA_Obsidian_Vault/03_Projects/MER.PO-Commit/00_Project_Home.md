...
Preserve the closed PO Commit project history.
...
No active delivery tasks are authorized.
...
- [[MER.PO-Commit/00_Project_Home|Project Home]]
- [[MER.PO-Commit/Project_Executive_Board|Project Executive Board]]
- [[MER.PO-Commit/Tasks|Tasks]]
...
| Priority | TBD |
| Business Owner | Needs Confirmation |
| Primary Users | MER / Uyen / Lam |
| BA / Coordination | Needs Confirmation |
| Technical Members | Lam, Uyen |
...
Project Memory:
[[03_Projects/_Registry/Project_Memory/MER.PO.Commit.v1.1.memory]]
