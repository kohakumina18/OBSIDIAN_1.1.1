...
| --- | --- | --- | --- | --- |
| FR-001 | Support the verified current outcome: Preserve the closed Stratova Pattern/Technical AI engagement while evaluating a new Google-related funding opportunity without automatic reactivation. | Project memory / root note | TBD | Needs Confirmation |
