---
type: project
project_name: "Accounting GRN Supplier Invoice Bot"
cluster: "Automation"
status: "Production"
priority: "P1"
confidence: "Strong"
...
`ACC.GRN-SupplierInvoiceBot.v2.3` is an Accounting bot that automates GRN and supplier invoice processing. It supports supplier invoice input, GRN-related data, extraction/mapping, validation, ERP/WFX interaction where applicable, exception handling, and user support.

Current status is Maintenance and Support. The bot is already operating and should continue with user support, exception handling, small bug fixes, and audit/log visibility.

Version note: the current active vault file is `ACC.GRN-SupplierInvoiceBot.v2.3`; `ACC.GRN-SupplierInvoiceBot.v1.1` should be treated as an older alias unless a separate approved rename/migration decision is made.
...
| ------- | -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ---------- |
| Project | ACC.GRN-SupplierInvoiceBot.v2.3                                                                                            | Current filename                                       | Strong     |
| Scope   | Accounting GRN and supplier invoice bot in maintenance/support; v1.1 is an older alias, current active vault file is v2.3. | User-provided project detail / memory layer / registry | Strong     |

Evidence sources:
03_Projects_Registry\PPJ_PROJECT_RESOURCE_MATRIX.md: [[ACC.GRN-SupplierInvoiceBot.v2.3]]]] | GRN Supplier Invoice Bot | [[PRODUCTION / SUPPORT]] / TBD | Uyên | Nam | Accounting | Invoice / Accounting / ERP Automation | Medium - production support | P1 | TBD | TBD | Next Actions | Accounting GRN Supplier Invoice Bot.md | 70 |
09_Stakeholders\PPJ_TEAM_WORKLOAD_MAP.md: [[ACC.GRN-SupplierInvoiceBot.v2.3]]]] - Invoice / Accounting / ERP Automation - P1
09_Stakeholders\PPJ_TEAM_WORKLOAD_MAP.md: [[ACC.GRN-SupplierInvoiceBot.v2.3]]]] - P1 - Accounting
...
Workspace:
[[ACC.GRN-SupplierInvoiceBot.v2.3/00_Project_Home]]

Executive Board:
[[ACC.GRN-SupplierInvoiceBot.v2.3/Project_Executive_Board]]

Tasks:
[[ACC.GRN-SupplierInvoiceBot.v2.3/Tasks]]

Governance:
[[ACC.GRN-SupplierInvoiceBot.v2.3/10_Governance/Decision_Log]]<!-- PPJ_PROJECT_KNOWLEDGE_END -->
