...
`PROD.IOT.CHuyenTreo.v1.0` is a production IoT/dashboard project that pulls data from hanging-line systems to build realtime or near-realtime dashboards and reports for production visibility.

The dashboard should support production monitoring through metrics such as output quantity, efficiency, downtime, line status, target vs actual, WIP if available, operation/process status, and time-based production trends.

Current status is Development, around 50%, with Linh as technical owner. Main risks are data source stability, KPI agreement, refresh delay, production validation, and device/system integration clarity.
...
| ------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ---------- |
| Project | PROD.IOT.CHuyenTreo_1                                                                                       | Current filename                                       | Strong     |
| Scope   | Production hanging-line realtime dashboard/reporting for output, efficiency, downtime, and line visibility. | User-provided project detail / memory layer / registry | Strong     |

Evidence sources:
03_Projects_Registry\PPJ_PROJECT_RESOURCE_MATRIX.md: |[[PROD.IOT.CHuyenTreo_1]]] | Chuyền Treo IoT Dashboard; Chuyền treo ver1 | DEVELOPMENT / TBD | Khoa | Huy, Lâm | Factory | Factory / IoT / Production | Medium - factory rollout support | P1 | TBD | TBD | Next Actions: | IOT.CHuyenTreo_1.md | 70 |
...
Workspace:
[[PROD.IOT.CHuyenTreo_1/00_Project_Home]]

Executive Board:
[[PROD.IOT.CHuyenTreo_1/Project_Executive_Board]]

Tasks:
[[PROD.IOT.CHuyenTreo_1/Tasks]]

Governance:
[[PROD.IOT.CHuyenTreo_1/10_Governance/Decision_Log]]<!-- PPJ_PROJECT_KNOWLEDGE_END -->
