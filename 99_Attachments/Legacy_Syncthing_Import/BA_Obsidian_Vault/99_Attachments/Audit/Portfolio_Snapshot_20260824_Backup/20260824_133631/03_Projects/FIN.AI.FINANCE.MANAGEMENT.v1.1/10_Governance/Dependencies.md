...
| --- | --- | --- | --- | --- |
| DEP-001 | Databricks Sources -> Finance Source Inventory -> Data Profiling -> Rule Engine -> OC Exception Detection -> Accounting Validation | Needs Confirmation | Open | PPJ-WEEKLY-20260727-20260801 |
