...
## Executive Summary
Project-specific details need confirmation. This project remains a canonical note for AI Automation Workshop and should be maintained without renaming, moving, archiving, deleting, or merging.
...
| Scope | Project-specific details need confirmation. This project remains a canonical note for AI Automation Workshop and should be maintained without renaming, moving, archiving, deleting, or merging. | Registry / current note / approved repair rules | Strong |
