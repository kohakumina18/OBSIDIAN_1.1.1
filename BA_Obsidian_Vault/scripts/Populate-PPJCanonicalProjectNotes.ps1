...
$seed = @{
    ...
    "FD.Datamart.v2.2.md" = @{ Summary="FD / fabric datamart using Directus as backend/admin/data platform, with QR design or QR information module and QR attached to hanger usage. Separate from CPD.Datamart.v1.1."; Department="FD"; Cluster="Sourcing / Material / Supplier Data"; Confidence="Strong for corrected business concept; implementation details need confirmation"; Type="data platform" }
    "CPD.Datamart.v1.1.md" = @{ Summary="CPD / 3D Design datamart for image search, 3D sample library, and visual sample assets. Separate from FD.Datamart.v2.2."; Department="CPD / 3D Design"; Cluster="Sourcing / Material / Supplier Data"; Confidence="Strong for corrected business concept; implementation details need confirmation"; Type="data platform" }
