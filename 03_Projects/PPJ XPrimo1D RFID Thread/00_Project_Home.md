---
type: "project_home"
project: "QC_ThreadTraceability_v1.0.0"
...
| Current File | PPJ XPrimo1D RFID Thread.md |
| Primary Domain | QC / TQM |
| Secondary Domains | MER, Customer, Factory |
| Lifecycle | Pre-contact / Internal Alignment |
| Progress | TBD |
| Current Gate | Pre-contact / Internal Alignment |
| Priority | TBD |
| Business Owner | Needs Confirmation |
| Primary Users | QC / Production / Khoa |
...
Project Memory:
[[03_Projects/_Registry/Project_Memory/QC.Primo1D.RFID.Thread.v1.0.memory]]
