...
| Field | Value |
| --- | --- |
| Canonical Code | WASH_COWASH_v2.0.0 |
| Legacy Code(s) | PROD.COWASH.v2.0; PROD.COWASH; COWASH |
...
| Priority | P2 |
| Business Owner | Needs Confirmation |
| Primary Users | Production / Wash / Khoa / Linh |
| BA / Coordination | Needs Confirmation |
| Technical Members | Linh |
...
Project Memory:
[[03_Projects/_Registry/Project_Memory/PROD.COWASH.v2.0.memory]]
