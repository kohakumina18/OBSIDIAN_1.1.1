---
type: "project_home"
project: "PUR_HMLabelProcessing_v1.0.0"
...
lifecycle: "On Hold"
current_gate: "Business priority paused"
priority: "Hold"
...
| Field | Value |
| --- | --- |
| Canonical Code | PUR_HMLabelProcessing_v1.0.0 |
| Legacy Code(s) | PUR.HM.LabelO.Processing.Automation.v1.0; PUR.HM.LabelO.Processing.Automation; H&M Label-O Processing |
...
| Status | On Hold |
| Progress | TBD |
| Current Gate | Business priority paused |
| Priority | Hold |
...
| Current File | PUR.H&M Label-O Processing.md |
| Primary Domain | Sourcing / Purchasing |
...
| Priority | P3 |
| Business Owner | Needs Confirmation |
| Primary Users | Purchasing / Uyen / Khoa / Nam |
| BA / Coordination | Needs Confirmation |
| Technical Members | Khoa, Nam |
...
Project Memory:
[[03_Projects/_Registry/Project_Memory/PUR.HM.LabelO.Processing.Automation.v1.0.memory]]
