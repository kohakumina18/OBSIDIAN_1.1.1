...
| --- | --- | --- | --- | --- |
| FR-001 | Support the verified current outcome: Production chatbot with department-level agents, permissions, logging, and controlled tool/API calling. | Project memory / root note | TBD | Needs Confirmation |
