...
| --- | --- | --- | --- | --- | --- |
| RISK-001 | Department permission leakage, API action audit, and difference between Q&A agents vs action agents. | Needs Confirmation | Needs Confirmation | Open | Canonical naming populated |
