...
date: "2026-06-29"
source: "manual"
raw_update_id: "20260629_000904"
detected_projects: ["PUR.Material.Allocation.v1.1"]
...
## Raw Update
Material Allocation hôm nay bị block vì chưa có realistic test data. Uyên đang follow user. Cần confirm WFX save draft flow trước khi UAT.

## Detected Projects

| Project | Match Type | Confidence | Reason |
|---|---|---|---|
|[[PUR.Material.Allocation.v1.2]]] | user_supplied | Needs Review | Supplied through -ProjectName |
