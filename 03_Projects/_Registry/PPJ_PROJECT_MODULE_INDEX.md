...
| ADMIN_ExpenseManagement_v1.1.0 | ADMIN_ExpenseManagement_v1.1.0.md | Administration | INTERNAL DEVELOPMENT | UAT / PRE-GO-LIVE | Active / Requirement Refinement / UAT Preparation | Active | Multi-traveler request model, end-to-end lifecycle and UAT preparation | P6 | Standardize Administration business-travel and expense-management workflows: Request -> Approval -> Business Trip -> Advance -> Expense -> Settlement. | 2026-09-18 |
| LOG_ExpenseInvoiceProcessing_v1.2.2 | PPJ. Expense-Invoices.v1.1.md | Logistics / EXIM | INTERNAL DEVELOPMENT | UAT / PRE-GO-LIVE | Regional Rollout / UAT | Active | Regional rollout, tax rules and invoice validation | P4 | Process Logistics / Import-Export expense invoices with regional and tax rules, invoice validation, user workflow and exception management. | 2026-09-18 |
