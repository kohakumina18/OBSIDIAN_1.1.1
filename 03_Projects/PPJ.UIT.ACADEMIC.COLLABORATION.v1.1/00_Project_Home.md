---
type: "project_home"
project: "EXT_AcademicCollaboration_v1.1.0"
...
| Field | Value |
| --- | --- |
| Canonical Code | EXT_AcademicCollaboration_v1.1.0 |
| Legacy Code(s) | PPJ.UIT.ACADEMIC.COLLABORATION.v1.1 |
...
| Current File | PPJ.UIT.ACADEMIC.COLLABORATION.v1.1.md |
| Primary Domain | External Collaboration |
| Secondary Domains | Education, Innovation, Talent Pipeline |
| Lifecycle | Partnership Follow-up / Confirmed Direction |
| Progress | TBD |
| Current Gate | Partnership Follow-up / Confirmed Direction |
| Priority | TBD |
| Business Owner | PPJ Group / UIT Faculty of Information Systems |
| Primary Users | PPJ / UIT / AISC / BA Coordination |
...
Project Memory:
[[03_Projects/_Registry/Project_Memory/PPJ.UIT.ACADEMIC.COLLABORATION.v1.1.memory]]
