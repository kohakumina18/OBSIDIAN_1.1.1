...
`PUR.Adhoc.Indent.South.v1.0` is an automation/support flow for South-region Adhoc Indent processing. It supports ad hoc purchasing/material requests that arise outside normal planning and helps standardize input/output and reduce manual effort.

Current status is Maintenance and Support. The flow is considered stable and should be maintained through bug fixes, exception handling, and support when input formats or business rules change.

The scope should remain miền Nam / South-region unless expansion is explicitly confirmed.
...
| ------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------ | ---------- |
| Project | PUR.Adhoc Indent mien Nam                                                           | Current filename                                       | Strong     |
| Scope   | South-region Adhoc Indent automation/support flow for Purchasing/material requests. | User-provided project detail / memory layer / registry | Strong     |

Evidence sources:
03_Projects_Registry\PPJ_PROJECT_RESOURCE_MATRIX.md: |[[PUR.Adhoc Indent mien Nam]]] | Adhoc Indent miền Nam; Adhoc Indent | PRODUCTION / SUPPORT / TBD | Uyên | Nam | Purchasing | Purchasing / MER Workflow | Medium - operational support | P2 | TBD | TBD | Next Actions: | Adhoc Indent mien Nam.md | 70 |
...
Workspace:
[[PUR.Adhoc Indent mien Nam/00_Project_Home]]

Executive Board:
[[PUR.Adhoc Indent mien Nam/Project_Executive_Board]]

Tasks:
[[PUR.Adhoc Indent mien Nam/Tasks]]

Governance:
[[PUR.Adhoc Indent mien Nam/10_Governance/Decision_Log]]<!-- PPJ_PROJECT_KNOWLEDGE_END -->
