...
| --- | --- | --- | --- | --- | --- |
| DEC-001 | Approve active-development closeout separately from external-data backlog. | Open | Needs Confirmation | TBD | PPJ-WEEKLY-20260727-20260801 |
| DEC-002 | Confirm data, permission and support ownership. | Open | Needs Confirmation | TBD | PPJ-WEEKLY-20260727-20260801 |
