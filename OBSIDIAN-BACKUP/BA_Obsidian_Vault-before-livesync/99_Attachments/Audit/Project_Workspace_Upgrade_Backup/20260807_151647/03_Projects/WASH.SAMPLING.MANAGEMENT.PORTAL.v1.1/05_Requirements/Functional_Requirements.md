...
| --- | --- | --- | --- | --- |
| FR-001 | Support the verified current outcome: Port and standardize wash sampling workflow into PPJ Group Portal. | Project memory / root note | P1 | Needs Confirmation |
